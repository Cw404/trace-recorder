 ...
 */
package cn.xusc.trace.example.dashboard.component.chart.echarts.bar;
 ...
 * @author wangcai
 */
public class TraceDashboardEchartsBarChartTest {

    /**
     * 跟踪仪表盘Echarts柱状图图表欢迎记录
     *
    ...
    public void welcomeTest(TraceRecorder recorder) {
        recorder.log("hello TraceDashboardEchartsBarChart");
    }

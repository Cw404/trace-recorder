 ...
 */
package cn.xusc.trace.example.dashboard.component.chart.echarts.relation;
 ...
 * @author wangcai
 */
public class TraceDashboardEchartsRelationChartTest {

    /**
     * 跟踪仪表盘Echarts关系图图表欢迎记录
     *
    ...
    public void welcomeTest(TraceRecorder recorder) {
        recorder.log("hello TraceDashboardEchartsRelationChart");
    }

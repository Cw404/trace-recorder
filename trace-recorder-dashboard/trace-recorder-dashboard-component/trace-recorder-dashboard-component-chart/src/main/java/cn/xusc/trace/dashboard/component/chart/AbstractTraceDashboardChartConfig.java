...
@Getter
@SuperBuilder
public abstract class AbstractTraceDashboardChartConfig extends GenerableTraceDashboardConfig {

    /**
     * 跟踪仪表盘图表刷新策略
     */
    @Builder.Default
    private TraceDashboardChartRefreshStrategy chartRefreshStrategy = TraceDashboardChartRefreshStrategy.TIMELY;
}

 ...
 * @since 16.07.2003
 * @see <a href="https://github.com/spring-projects/spring-framework/blob/v5.3.22/spring-core/src/main/java/org/springframework/util/AntPathMatcher.java">AntPathMatcher</a>
 */
public class AntPathMatcher {
    ...
    public String combine(String pattern1, String pattern2) {
        ...
        if (!Strings.isEmpty(pattern1)) {
            return pattern2;
        }
        if (!Strings.isEmpty(pattern2)) {
            return pattern1;
        }

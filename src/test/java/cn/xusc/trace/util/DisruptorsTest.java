...
public class DisruptorsTest {
    ...
    public <T> void singleSharedConsumerModelDisruptorsTest(int bufferSize, TeConsumer<? super Disruptors.GeneralEvent, ? super Long, ? super Boolean> teConsumer,
                                                            Supplier<T> supplier, int count) {
        Disruptor<Disruptors.GeneralEvent> disruptor = Disruptors.generate(bufferSize);
        Disruptors.consumer(disruptor)
                .addConsumptionPatterns(teConsumer)
                .consume();
        Disruptors.producer(disruptor)
    ...
    public <T> void multipleSharedConsumerModelDisruptorsTest(int bufferSize, TeConsumer<? super Disruptors.GeneralEvent, ? super Long, ? super Boolean> teConsumer,
                                                              Supplier<T> supplier, int count) {
        Disruptor<Disruptors.GeneralEvent> disruptor = Disruptors.generate(bufferSize);
        Disruptors.consumer(disruptor)
                .addConsumptionPatterns(teConsumer)
    ...
    public <T> void singleNoSharedConsumerModelDisruptorsTest(int bufferSize, Consumer<? super Disruptors.GeneralEvent> consumer,
                                                              Supplier<T> supplier, int count) {
        Disruptor<Disruptors.GeneralEvent> disruptor = Disruptors.generate(bufferSize);
        Disruptors.consumer(disruptor)
    ...
    public <T> void multipleNoSharedConsumerModelDisruptorsTest(int bufferSize, Consumer<? super Disruptors.GeneralEvent> consumer,
                                                                Supplier<T> supplier, int count) {
        Disruptor<Disruptors.GeneralEvent> disruptor = Disruptors.generate(bufferSize);
        Disruptors.consumer(disruptor)
                .addConsumptionPatterns(consumer)
